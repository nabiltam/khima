...
import { Target, Calendar, Clock, TrendingUp, Plus, Sparkles, Heart, Volume2, VolumeX } from 'lucide-react';
    ...
    <div className="space-y-6 lg:space-y-10 relative">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 lg:gap-8 relative z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={togglePlay}
            className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-primary shadow-xl border border-border hover:bg-primary/5 transition-all active:scale-95"
